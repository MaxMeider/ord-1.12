...
class OpenResourceDiscoveryService extends cds.ApplicationService {
    async init() {
        ...
        cds.app.get(`/open-resource-discovery/v1/:ordId/:service`, authMiddleware, metadataHandler);
        cds.app.get(`/open-resource-discovery/v1/:ordId`, authMiddleware, metadataHandler);
